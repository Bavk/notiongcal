...
NOTION_TOKEN = "secret_ds5iwn1tioULY5Yhm5ctE8sPgMomaCs8NwfGMSz2pt9" #the secret_something from Notion Integration

database_id = "96d31c6efb32400299c53b206c0794e1" #get the mess of numbers before the "?" on your dashboard URL (no need to split into dashes)

urlRoot = 'https://www.notion.so/luxcode/96d31c6efb32400299c53b206c0794e1?v=eb08432be1b54942910d0dc601a80ac9&p=' #open up a task and then copy the URL root up to the "p="
...
timezone = 'Europe/Kaliningrad' #Choose your respective time zone: http://www.timezoneconverter.com/cgi-bin/zonehelp.tzc
...
DEFAULT_CALENDAR_ID = '6vjjdst2qam58o4t8e0e3qdpd4@group.calendar.google.com' #The GCal calendar id. The format is something like "sldkjfliksedjgodsfhgshglsj@group.calendar.google.com"
...
calendarDictionary = {
    ...
    'Notion' : '6vjjdst2qam58o4t8e0e3qdpd4@group.calendar.google.com', #just typed some random ids but put the one for your calendars here
}
...
Background_Notion_Name = 'background'
...
def makeCalEvent(eventName, eventDescription, eventStartTime, sourceURL, eventEndTime, calId):
    if eventDescription == "Важно":
        setcolor = '6'
    elif eventDescription == "Не важно":
        setcolor = '10'
    elif eventDescription == "Срочно":
        setcolor = '11'
    else:
        setcolor = '7' 
